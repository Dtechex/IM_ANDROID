...
public class MediaFolderPickerFragment extends BaseFragment
    ...
    private void updateList(List<PhotoDirectory> dirs) {
        ...
        if (photoGridAdapter != null) {
            ...
            photoGridAdapter = new FolderGridAdapter(getActivity(), mGlideRequestManager,
                    (ArrayList<PhotoDirectory>) dirs, null,
                    (fileType == FilePickerConst.MEDIA_TYPE_IMAGE) && PickerManager.getInstance()
                            .isEnableCamera());
    ...
    @Override public void onFolderClicked(PhotoDirectory photoDirectory) {
