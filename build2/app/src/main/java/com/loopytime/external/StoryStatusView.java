...
public class StoryStatusView extends LinearLayout {
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        /*TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.StoryStatusView);
        storiesCount = typedArray.getInt(R.styleable.StoryStatusView_progressCount, 0);
        typedArray.recycle();*/
        bindViews();
    }
