...
import com.loopytime.external.videotrimmer.view.animators.BarParamsAnimator;
import com.loopytime.external.videotrimmer.view.animators.IdleAnimator;
import com.loopytime.external.videotrimmer.view.animators.RmsAnimator;
import com.loopytime.external.videotrimmer.view.animators.RotatingAnimator;
import com.loopytime.external.videotrimmer.view.animators.TransformAnimator;
...
public class SpeechProgressView extends View {
    ...
    private void startIdleInterpolation() {
        ...
        animator.start();
        System.out.println("statrr startIdleInterpolation");
    }

    private void startRmsInterpolation() {
        resetBars();
        System.out.println("statrr rms");
