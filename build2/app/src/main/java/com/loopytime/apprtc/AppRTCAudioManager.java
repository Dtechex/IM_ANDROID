...
//        AppRTCUtils.logDeviceInfo(TAG);
    ...
    public void setDefaultAudioDevice(AudioDevice defaultDevice) {
        ...
        switch (defaultDevice) {
            ...
            case EARPIECE:
                ...
                break;
            case WIRED_HEADSET:
                defaultAudioDevice = AudioDevice.WIRED_HEADSET;
                break;
            default:
    ...
    public void changeAudioMode(int audioMode) {
        audioManager.setMode(audioMode);
        savedAudioMode = audioMode;
    }
    ...
    public void updateAudioDeviceState() {
        ...
        if (hasWiredHeadset && userSelectedAudioDevice != AudioDevice.SPEAKER_PHONE) {
            // If user turn off speaker phone, but then plugged wired headset then make
            // wired headset as user selected device.
        ...
        if (!hasWiredHeadset && userSelectedAudioDevice == AudioDevice.EARPIECE) {
            // If user selected speaker phone, but then plugged wired headset then make
            // wired headset as user selected device.
        ...
        } else if (hasWiredHeadset && defaultAudioDevice == AudioDevice.SPEAKER_PHONE) {
            // If a wired headset is connected, but Bluetooth is not, then speaker is used as
            // audio device.
