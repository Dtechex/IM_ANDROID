...
import com.loopytime.apprtc.AppRTCClient.SignalingParameters;
...
public class RoomParametersFetcher {
    ...
    private void roomHttpResponseParse(String response) {
        ...
        try {
            ...
            JSONObject json = new JSONObject(roomJson.getString("pc_config"));
    ...
    private List<PeerConnection.IceServer> requestTurnServers(String url)
        ...
        connection.setRequestProperty("REFERER", Constants.APPRTC_URL);
