    ...
    public void getAutoStartPermission(Context context) {
        ...
        switch (build_info) {
            ...
            case BRAND_OPPO:
                ...
                /*new AlertDialog.Builder(context).setTitle(Build.MANUFACTURER + " Protected Apps")
                        .setMessage("ALLOW")
                        .setPositiveButton("Go to settings", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                try {
                                    ...
                                    Log.e("AutoStartPermission", "onClick: "+e.getMessage() );
                                    try {
                                        Intent intent = new Intent();
                                        ...
                                        Log.e("AutoStartPermission", "onClick: "+ex.getMessage() );
                                        try {
                                            Intent intent = new Intent();
                                            intent.setClassName("com.coloros.safecenter",
                                            ...
                                            Log.e("AutoStartPermission", "onClick: "+exx.getMessage() );
                                        }
                                    }
                                }
                            }
