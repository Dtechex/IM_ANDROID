...
abstract class CameraImpl {
    ...
    abstract boolean getFlashSupport(@Facing int facing);
    ...
    abstract void captureVideo(Context context, File videoFile, int maxDuration, VideoCapturedCallback callback);
